...
var MAX_DELTA = 0.2;
var KEYS = [
  'KeyW', 'KeyA', 'KeyS', 'KeyD', 'KeyQ', 'KeyZ',
  'ArrowUp', 'ArrowLeft', 'ArrowRight', 'ArrowDown', 'Space', 'ShiftLeft'
];

/**
 * WASD component to control entities using WASD keys.
 */
//module.exports.Component = registerComponent('wasdqz-controls', {
AFRAME.registerComponent('wasdqz-controls', {
  schema: {
  ...
  tick: function (time, delta) {
    ...
    if (!velocity[data.adAxis] && !velocity[data.wsAxis] && !velocity[data.qzAxis] &&
  ...
  updateVelocity: function (delta) {
    ...
    if (data.qzEnabled) {
      ...
      if (keys.KeyZ || keys.ShiftLeft) { velocity[qzAxis] -= qzSign * acceleration * delta; }
      if (keys.KeyQ || keys.Space) { velocity[qzAxis] += qzSign * acceleration * delta; }
    }
  },
